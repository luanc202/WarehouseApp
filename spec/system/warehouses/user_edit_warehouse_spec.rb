...
describe 'Usuário edita um galpão' do
  ...
  it 'com sucesso' do
    ...
    # Act
      ...
      fill_in 'Endereço' , with: 'Avenida dos Galpões, 200'
      fill_in 'CEP' , with: '16700-000'
    ...
    expect(page).to have_content('Endereço: Avenida dos Galpões, 200')
    expect(page).to have_content('CEP: 16700-000')
  end
